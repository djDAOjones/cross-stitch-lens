 ...
 *
 * Deterministic fixtures generated by the TS reference stand in for
 * golden files: `tests/golden/**` is protected and adding M8 fixtures
 * there needs the owner's explicit approval (see backlog M8-ALG-01).
 */
