...
- [~] **M15-GALLERY-01 Profile gallery: culture & nature** [sign-off] [detail] (2026-08-07)
  ...
  Status 2026-08-09 (D140): **batch 1 signed** — 5 rule-shaped (Autumn leaves, Golden hour, Winter frost, Deep sea, Neon noir) + 3 curated (De Stijl primaries, Delft blue, Ukiyo-e woodblock) ship as built-ins; see trajectory. Both open questions closed by the owner: rule-shaped profiles keep all-brands, and Neon noir is signed with its grey-floor residual named (a rename was declined — do not "fix" it without asking). Item stays open for later batches against the ticket's remaining ~49 candidates. Two carry-overs, neither gating: the photo-slot half of the evidence format needs owner images in `public/profile-demo/`, and the `ariadna:1650` catalogue row is wish-listed. The ticket's "blocked on M15-CORE-02" line is stale — CORE-02 (D122) and UI-04 (D123) both shipped.
