...
- [ ] 2026-08-11 AGENTS.md § Product identity — "macOS-first" and the edits-in-Photoshop premise both widen: the owner intends to publish online to a broader audience on any platform, so no upstream editor can be assumed (source: D149/brief.md)
...
- [ ] 2026-08-11 All three protected docs — the product name changes to Pattern Mapper at RENAME-01. Deliberately **not** split per doc: one rename, one sweep, and it must be reconciled in the same sitting as the rename itself (source: D149/RENAME-01)
